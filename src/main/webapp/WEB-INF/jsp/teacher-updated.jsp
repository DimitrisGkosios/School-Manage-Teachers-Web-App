...
<main class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 text-center">
        <!-- Success Message -->
        <h1 class="text-3xl font-bold text-success-600 mb-4">Επιτυχής Ενημέρωση</h1>
        <p class="text-lg text-gray-700 mb-2"><strong>Κωδικός:</strong> ${sessionScope.teacherInfo.id}</p>
